...
const NewsData = [
  {
    ...
    icon: <FaCameraRetro className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img1,
  ...
  },
  {
    ...
    icon: <GiNotebook className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img2,
  ...
  },
  {
    ...
    icon: <SlNote className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img3,
  ...
  },
  {
    ...
    icon: <FiShield className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img4,
  ...
  },
  {
    ...
    icon: <FiGlobe className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img1,
  ...
  },
  {
    ...
    icon: <FiZap className="text-4xl text-accent group-hover:text-black duration-300" />,
    image: img2,
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-between items-center mb-12">
        <h1
          className="text-4xl font-bold text-[#d1c7b7]"
        ...
        {NewsData.map((news, index) => (
          <div
            ...
            className="
              ...
              hover:bg-gradient-to-r from-[#9B1C1C] to-[#7A1616] 
              hover:shadow-[0_0_30px_rgba(155,28,28,0.6)] 
              transition-all 
              text-[#d1c7b7] 
              hover:text-black 
              rounded-xl 
          ...
          >
            ...
            <a
              href={news.link}
              className="inline-block mt-6 text-accent text-lg font-semibold group-hover:text-black duration-300"
            >
              Learn More →
            </a>
          </div>
